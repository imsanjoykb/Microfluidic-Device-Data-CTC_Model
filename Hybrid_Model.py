...
from tensorflow.keras.layers import Input, Conv1D, MaxPooling1D, GlobalAveragePooling1D, Dense, LSTM, concatenate, Dropout
...
plt.title('Accuracy Curve CNN+LSTM', fontsize=16, fontweight='bold')
...
plt.title('Receiver Operating Characteristic (ROC) Curve (CNN+LSTM)', fontsize=16, fontweight='bold')
